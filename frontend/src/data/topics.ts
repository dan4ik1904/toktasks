...
export const TOPICS: Topic[] = [
  // ================= УРОВЕНЬ 1 · Начинающий =================
  {
    ...
    tasks: [
      ...
      {"id": "alf-6", "type": "listen", "question": "Прослушай аудио и напиши букву («Ә» — мягкое А)", "answer": "Ә", "reward": 8},
  ...
  // ================= УРОВЕНЬ 3 · Средний =================
  {
    ...
    tasks: [
      ...
      {"id": "vre-6", "type": "listen", "question": "Прослушай и напиши глагол («Яза» — пишет)", "answer": "Яза", "reward": 8},
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "kil-7", "type": "listen", "question": "Прослушай и напиши слово («Өстәл» — стол)", "answer": "Өстәл", "reward": 8},
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "dia-6", "type": "listen", "question": "Прослушай и напиши фразу («Хәерле көн» — добрый день)", "answer": "Хәерле көн", "reward": 8},
  ...
  // ================= УРОВЕНЬ 4 · Продвинутый =================
  {
    ...
    tasks: [
      ...
      {"id": "mak-6", "type": "listen", "question": "Прослушай и напиши слово («Мәкаль» — пословица)", "answer": "Мәкаль", "reward": 10},
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "mad-6", "type": "listen", "question": "Прослушай и напиши слово («Казан» — Казань)", "answer": "Казан", "reward": 10},
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "kat-7", "type": "listen", "question": "Прослушай и напиши союз («Чөнки» — потому что)", "answer": "Чөнки", "reward": 10},
