...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "priv-3", "type": "truefalse", "question": "«Минем исемем Айрат» означает «Меня зовут Айрат»", "answer": "true", "options": ["true", "false"], "reward": 5},
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "sem-2", "type": "translate", "question": "Как будет «папа» по-татарски?", "answer": "Әти", "options": ["Әни", "Әти", "Бабай", "Кыз"], "reward": 5},
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "gor-3", "type": "compose", "question": "Составь предложение: «Каждый день я езжу на автобусе в центр города»", "words": ["Көн", "саен", "мин", "автобус", "белән", "шәһәр", "үзәгенә", "барам"], "answer": "Көн саен мин автобус белән шәһәр үзәгенә барам", "reward": 12},
      {"id": "gor-4", "type": "truefalse", "question": "«Мәктәп» означает «школа»", "answer": "true", "options": ["true", "false"], "reward": 5},
      {"id": "gor-5", "type": "grammar", "question": "Мин автобус ___ барам.", "answer": "белән", "options": ["белән", "өчен", "турында", "аша"], "reward": 7},
      ...
      {"id": "gor-8", "type": "speak", "question": "Произнеси: «Мин Казан урамнары буйлап йөрим»", "answer": "Мин Казан урамнары буйлап йөрим", "speakText": "Мин Казан урамнары буйлап йөрим", "reward": 10},
  ...
  // ================= УРОВЕНЬ 4 · Продвинутый =================
  {
    ...
    tasks: [
      ...
      {"id": "mak-2", "type": "grammar", "question": "В пословице «Кем эшләми — шул ___» (Кто не работает — тот не ест) пропущено слово", "answer": "ашамый", "options": ["ашамый", "эшли", "йоклый", "бара"], "reward": 8},
      ...
      {"id": "mak-4", "type": "truefalse", "question": "«Әйткән сүз — аткан ук» — пословица о том, что сказанного не воротишь", "answer": "true", "options": ["true", "false"], "reward": 6},
      {"id": "mak-5", "type": "translate", "question": "Что значит поговорка «Авыз эчендә ботка пешерә»?", "answer": "Говорит невнятно (каша во рту)", "options": ["Говорит невнятно (каша во рту)", "Поёт красиво", "Молчит всегда", "Кричит громко"], "reward": 6},
      ...
      {"id": "mak-8", "type": "truefalse", "question": "«Тырышкан табар, ташка кадак кагар» означает «Усердный добьётся своего»", "answer": "true", "options": ["true", "false"], "reward": 6},
  ...
  },
  {
    ...
    tasks: [
      ...
      {"id": "mad-7", "type": "translate", "question": "Столица Татарстана — ___", "answer": "Казан", "options": ["Казан", "Уфа", "Әлмәт", "Самара"], "reward": 6},
