...
const DICT: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    platformTitle: "TATARCHA • Платформа",
    aiTutorCardTitle: "Иптәш • ИИ-Репетитор",
  ...
  en: {
    ...
    platformTitle: "TATARCHA • Platform",
    aiTutorCardTitle: "Iptäsh • AI Tutor",
  ...
  tt: {
    ...
    platformTitle: "TATARCHA • Платформа",
    aiTutorCardTitle: "Иптәш • СИ-Репетитор",
